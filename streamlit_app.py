...
with t_monitor:
    ...
    with c_left:
        ...
        st.divider()
        cat = st.radio("板塊掃描", list(pool_390.keys()), horizontal=True, key="scan_radio_unique")
        for tid, tname in pool_390[cat][:10]: # 限制顯示避免過長
