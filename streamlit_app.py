...
# --- [第 4 區：大基石 425 檔名單 (2026 擴張版)補回缺失的 pool_390 定義 (範例)] ---
# 您必須在代碼中定義這個變數，否則會持續出現 NameError
pool_390 = {
    "半導體": ["2330.TW", "2454.TW"],
    "航運": ["2603.TW", "2618.TW"],
    "塑膠": ["1301.TW"]
...
pool_425 = {
    ...
    "🎮 數位文創/遊戲 (15)": [
        ...
        ("3546.TW","宇峻"), ("4946.TW","辣椒"), ("6111.TW","暑光"), ("6169.TW","昱泉"), 
        ("2723.TW","美食-KY"), ("8446.TW","華研"), ("3687.TW","歐買尬"), ("6111.TW","大宇資"),
        ("2912.TW","統一超"), ("5903.TW","全家"), ("9943.TW","好樂迪")
    ],
    "💎 權值/金控 (70)": [
        ("2330.TW","台積電"), ("2317.TW","鴻海"), ("2454.TW","聯發科"), ("2881.TW","富邦金"), 
        ("2882.TW","國泰金"), ("2303.TW","聯電"), ("2886.TW","兆豐金"), ("2891.TW","中信金"), 
        ("2412.TW","中華電"), ("1301.TW","台塑"), ("2002.TW","中鋼"), ("2884.TW","玉山金"), 
        ("5880.TW","合庫金"), ("2885.TW","元大金"), ("5871.TW","中租-KY"), ("2883.TW","開發金"), 
        ("2887.TW","台新金"), ("2892.TW","第一金"), ("2890.TW","永豐金"), ("1101.TW","台泥"), 
        ("1216.TW","統一"), ("2357.TW","華碩"), ("2324.TW","仁寶"), ("2353.TW","宏碁"), 
        ("2382.TW","廣達"), ("2880.TW","華南金"), ("1303.TW","南亞"), ("1326.TW","台化"), 
        ("6505.TW","台塑化"), ("2105.TW","正新"), ("2207.TW","和泰車"), ("2377.TW","微星"), 
        ("2395.TW","研華"), ("2408.TW","南亞科"), ("2474.TW","可成"), ("2603.TW","長榮"), 
        ("2609.TW","陽明"), ("2610.TW","華航"), ("2615.TW","萬海"), ("2618.TW","長榮航"), 
        ("2801.TW","彰銀"), ("2888.TW","新光金"), ("2889.TW","國票金"), ("2897.TW","王道銀行"), 
        ("5876.TW","上海商銀"), ("9904.TW","寶成"), ("9910.TW","豐泰"), ("9921.TW","巨大"), 
        ("9945.TW","潤泰新"), ("1476.TW","儒星"), ("1477.TW","聚陽"), ("1717.TW","長興"), 
        ("1722.TW","台肥"), ("1802.TW","台玻"), ("2006.TW","東和鋼鐵"), ("2014.TW","中鴻"), 
        ("2027.TW","大成鋼"), ("2106.TW","建大"), ("2201.TW","裕隆"), ("2204.TW","中華車"),
        ("1504.TW","東元"), ("2809.TW","京城銀"), ("2834.TW","臺企銀"), ("2845.TW","遠東銀"),
        ("2851.TW","中再保"), ("2855.TW","元富證"), ("6005.TW","群益證"), ("9933.TW","中鼎"),
        ("9941.TW","裕融"), ("1210.TW","大成")
    ],
   "🔬 半導體/IC/設備 (70)": [
