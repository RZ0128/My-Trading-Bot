...
pool_500 = {
    ...
    "半導體/IC設計/封測": [
        ...
        ("3583", "辛耘"), ("6533", "晶心科"), ("6515", "穎崴"), ("3189", "景碩"), ("8039", "台達化"), ("3376", "新日興"), ("6182", "合晶"), ("8299", "群聯"),
        ("6202", "盛群"), ("3264", "欣銓"), ("5483", "中美晶"), ("6488", "環球晶"), ("3532", "台勝科"), ("3016", "嘉晶"), ("2401", "凌陽"), ("2436", "偉詮電"),
        ("2458", "義隆"), ("3014", "聯陽"), ("3041", "揚智"), ("4952", "凌通"), ("5285", "界霖"), ("6233", "旺玖"), ("6243", "迅杰"), ("6679", "鈺太"),
        ("8028", "昇陽半導體"), ("8081", "致新"), ("3218", "大學光"), ("3413", "京鼎"), ("3557", "嘉威"), ("3588", "通嘉"), ("4967", "十銓"), ("4968", "立積"),
        ("5222", "全訊"), ("5272", "笙科"), ("6147", "頎邦"), ("6417", "聖暉*"), ("6435", "大中"), ("6451", "訊芯-KY"), ("6462", "神盾"), ("6494", "九齊"),
        ("6510", "精測"), ("6531", "愛普*"), ("6568", "宏觀"), ("6613", "朋程"), ("6643", "M31"), ("6684", "安格"), ("6719", "力智"), ("6732", "昇佳電子"),
        ("6756", "威鋒電子"), ("8054", "安國"), ("8261", "富鼎"), ("8271", "宇瞻"), ("2329", "華泰"), ("2369", "菱生"), ("2449", "京元電子"), ("3265", "台星科"),
        ("6257", "矽格"), ("6271", "同欣電"), ("6664", "群翊"), ("3563", "牧德"), ("2467", "志聖"), ("6640", "均華"), ("3131", "弘塑"), ("6187", "萬潤"), ("1560", "中砂")
    ],
    "AI伺服器/電腦組裝": [
        ...
        ("3209", "全科"), ("4916", "事欣科"), ("6235", "華孚"), ("8215", "明基材"), ("2364", "倫飛"), ("2352", "佳世達"), ("2417", "圓剛"), ("3057", "喬鼎"),
        ("3062", "建漢"), ("4953", "緯軟"), ("5215", "科嘉-KY"), ("5469", "瀚宇博"), ("6117", "盟立"), ("6121", "新普"), ("6142", "友勁"), ("6153", "嘉聯益"),
        ("6197", "佳必琪"), ("6205", "詮欣"), ("6206", "飛捷"), ("6213", "聯茂"), ("6214", "精誠"), ("6245", "立端"), ("6277", "宏齊"), ("6281", "全國電"),
        ("6285", "啟碁"), ("6409", "旭隼"), ("6414", "樺漢"), ("6441", "廣錠"), ("6579", "研揚"), ("8050", "廣積"), ("8064", "東捷"), ("8076", "伍豐"),
        ("8096", "擎亞"), ("8114", "振曜"), ("8410", "森田"), ("2312", "金寶"), ("2328", "廣宇")
    ],
    "網通/零組件/散熱": [
        ...
        ("5225", "東科-KY"), ("6101", "弘凱"), ("6143", "振曜"), ("6190", "萬泰科"), ("6216", "居易"), ("6241", "易通展"), ("6282", "康舒"), ("2486", "一詮"),
        ("3023", "信邦"), ("2308", "台達電"), ("6230", "超眾"), ("3653", "健策"), ("2482", "連宇"), ("3046", "建碁"), ("3211", "順達"), ("3321", "同泰"),
        ("3693", "營邦"), ("4935", "茂林-KY"), ("4989", "榮科"), ("5439", "高技"), ("6108", "競國"), ("6141", "柏承"), ("6220", "岳豐"), ("6274", "台燿"),
        ("6278", "台表科"), ("8155", "博智")
    ],
    "塑膠/化學/傳產": [
        ("1301", "台塑"), ("1303", "南亞"), ("1313", "聯成"), ("1304", "台聚"), ("1308", "亞聚"), ("1310", "台苯"), ("1312", "國喬"), ("1314", "中石化"),
        ("1326", "台化"), ("2105", "正新"), ("1101", "台泥"), ("1102", "亞泥"), ("1216", "統一"), ("1402", "遠東新"), ("2002", "中鋼"), ("2014", "中鴻"),
        ("2006", "東和鋼鐵"), ("2106", "建大"), ("1717", "長興"), ("1722", "台肥"), ("1723", "中碳"), ("4763", "材料-KY"), ("1701", "中化"), ("1708", "東鹼"),
        ("1709", "和益"), ("1710", "東聯"), ("1711", "永光"), ("1712", "興農"), ("1713", "國化"), ("1714", "和桐"), ("1718", "中纖"), ("1720", "生達"),
        ("1721", "三晃"), ("1725", "元禎"), ("1726", "永記"), ("1727", "中華化"), ("1730", "花仙子"), ("1731", "美吾華"), ("1732", "毛寶"), ("1733", "五鼎"),
        ("1734", "杏輝"), ("1735", "日勝化"), ("1736", "喬山"), ("1737", "臺鹽"), ("1752", "南光"), ("1773", "勝一"), ("1776", "展宇"), ("1783", "和康生"),
        ("1786", "科妍"), ("1789", "神隆"), ("1802", "台玻"), ("1904", "正隆"), ("1907", "永豐餘"), ("1909", "榮成"), ("2103", "台橡"), ("2104", "國際中橡"),
        ("2108", "南帝"), ("6505", "台塑化"), ("9904", "寶成")
    ],
    "金融保險": [
        ...
        ("2867", "三商壽"), ("6005", "群益證"), ("6016", "康和證"), ("6023", "元大期"), ("6024", "群益期"), ("6026", "福邦證")
    ],
    "航運/重電/電機": [
        ("2603", "長榮"), ("2609", "陽明"), ("2615", "萬海"), ("2610", "華航"), ("2618", "長榮航"), ("1503", "士電"), ("1504", "東元"), ("1513", "中興電"),
        ("1519", "華城"), ("1514", "亞力"), ("1605", "華新"), ("1608", "華榮"), ("1609", "大亞"), ("1517", "利奇"), ("2633", "台灣高鐵"), ("2634", "漢翔"),
        ("2637", "慧洋-KY"), ("5607", "遠雄港"), ("2601", "益航"), ("2605", "新興"), ("2606", "裕民"), ("2607", "榮運"), ("2608", "嘉里大榮"), ("2611", "志信"),
        ("2612", "中航"), ("2617", "台航"), ("2630", "亞航"), ("2636", "台驊投控"), ("1512", "瑞智"), ("1521", "大億"), ("1522", "堤維西"), ("1524", "耿鼎"),
        ("1532", "勤美"), ("1536", "和大"), ("1537", "廣隆")
    ],
    "生技/遊戲/其他": [
        ("1760", "寶齡富錦"), ("6472", "保瑞"), ("1795", "美時"), ("4174", "浩鼎"), ("9910", "豐泰"), ("9921", "巨大"), ("2912", "統一超"), ("5904", "寶雅"),
        ("3293", "鈊象"), ("5478", "智冠"), ("6111", "大宇資"), ("6180", "橘子"), ("8454", "富邦媒"), ("9933", "中鼎"), ("4104", "佳醫"), ("4114", "健喬"),
        ("4123", "晟德"), ("4128", "中天"), ("4137", "麗豐-KY"), ("4142", "國光生"), ("4743", "合一"), ("6446", "藥華藥"), ("6547", "高端疫苗")
    ]
}

# 3. 反向映射表 (自動根據 pool_500 生成，不用再手打第二次)
STOCK_MAP = {}
for cat_list in pool_500.values():
    for sid, sname in cat_list:
        STOCK_MAP[sid] = sname
...
with tab_scan:
    ...
    with col_l:
            ...
            if s_input:
                ...
                if matches:
                    ...
                    for idx, (m_sid, m_sname) in enumerate(matches[:9]):
                        with m_cols[idx % 3]:
                            if st.button(f"🎯 {m_sname}", key=f"src_{m_sid}"):
                    ...
                    with st.container(border=True):
                        ...
                        with sc1:
                            ...
                            if st.button(f"🚀 確認執行佈局", key=f"cf_buy_{sel_sid}", use_container_width=True):
                                new_entry = pd.DataFrame([{'client': st.session_state.cur_c, 'id': sel_sid, 'name': STOCK_MAP.get(sel_sid.split('.')[0], '標的'), 'buy_price': p, 'shares': q_val, 'unit': u_val, 'entry_reason': res['msg'], 'current_score': res['score'], 'last_diag': datetime.now().strftime("%m-%d")}])
                                ...
                                save_data(); st.success("✅ 已加入持股"); st.rerun()
                        with sc2:
                            st.metric("即時股價", p, d)
        ...
        cat_choice = st.radio("選擇掃描板塊", list(pool_500.keys()), horizontal=True, key="cat_radio_v127")
        ...
        for item in top_picks:
            with st.expander(f"⭐ {item['tname']} | 評分: {item['score']} | 價: {item['price']}"):
                ...
                if k_c3.button(f"🚀 快速佈局 {item['tname']}", key=f"bp_{item['base_id']}", use_container_width=True):
                    new_entry = pd.DataFrame([{'client': st.session_state.cur_c, 'id': item['tid'], 'name': item['tname'], 'buy_price': item['price'], 'shares': quick_q, 'unit': quick_u, 'entry_reason': item['msg'], 'current_score': item['score'], 'last_diag': datetime.now().strftime("%m-%d")}])
                    st.session_state.local_db = pd.concat([st.session_state.local_db, new_entry], ignore_index=True)
